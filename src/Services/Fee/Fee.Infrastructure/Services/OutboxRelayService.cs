// Fee.Infrastructure/Services/OutboxRelayService.cs
...
public sealed class OutboxRelayService : OutboxRelayServiceBase<FeeDbContext>
{
    ...
    protected override string TopicName => KafkaTopics.FeeEvents;
}
