...
// falls back to 'FeeDb' in single-region / Minikube environments.
...
public sealed class FeeDbContextReadOnly : DbContext
{
    private readonly ITenantContext? _tenant;

    public FeeDbContextReadOnly(
        DbContextOptions<FeeDbContextReadOnly> options,
    ...
    public override int SaveChanges(bool acceptAllChangesOnSuccess) =>
        throw new InvalidOperationException(
            "FeeDbContextReadOnly is a read-only context. Use FeeDbContext for writes.");
