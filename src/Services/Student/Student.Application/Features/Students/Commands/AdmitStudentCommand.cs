...
public sealed record AdmitStudentCommand(Guid StudentId, Guid TenantId) : IRequest;

public sealed class AdmitStudentCommandHandler : IRequestHandler<AdmitStudentCommand>
{
    ...
    public async Task Handle(AdmitStudentCommand request, CancellationToken ct)
    {
