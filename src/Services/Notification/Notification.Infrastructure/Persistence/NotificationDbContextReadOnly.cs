...
// falls back to 'NotificationDb' in single-region / Minikube environments.
...
public sealed class NotificationDbContextReadOnly : DbContext
{
    private readonly ITenantContext? _tenant;

    public NotificationDbContextReadOnly(
        DbContextOptions<NotificationDbContextReadOnly> options,
    ...
    public override int SaveChanges(bool acceptAllChangesOnSuccess) =>
        throw new InvalidOperationException(
            "NotificationDbContextReadOnly is a read-only context. Use NotificationDbContext for writes.");
