...
{
    public AcademicEventsConsumer(IServiceScopeFactory scopeFactory, ILogger<AcademicEventsConsumer> logger)
        : base(scopeFactory, logger, "academic-events", "notification-academic-group") { }
