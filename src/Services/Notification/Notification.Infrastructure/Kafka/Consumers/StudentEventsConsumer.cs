...
{
    public StudentEventsConsumer(IServiceScopeFactory scopeFactory, ILogger<StudentEventsConsumer> logger)
        : base(scopeFactory, logger, "student-events", "notification-student-group") { }
