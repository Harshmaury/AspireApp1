...
{
    public IdentityEventsConsumer(IServiceScopeFactory scopeFactory, ILogger<IdentityEventsConsumer> logger)
        : base(scopeFactory, logger, "identity-events", "notification-identity-group") { }
