...
{
    // WRITE PATH - tracked. Command handlers only.
    ...
    // READ-ONLY PATH - untracked. Query handlers only.
    Task<FacultyEntity?> GetByIdReadOnlyAsync(Guid id, Guid tenantId, CancellationToken ct = default);
