...
internal sealed class CourseAssignmentRepository : ICourseAssignmentRepository
{
    private readonly FacultyDbContext _db;
    public CourseAssignmentRepository(FacultyDbContext db, ITenantContext? tenant = null) => _db = db;
